...
def main():
    ...
    print("[vj] keys: 1-0 clip-browse · QWERTY overlay-browse · ASDFGHJKL generative · ZXCVB hits · F1-F7 FX · ←→↑↓ params · F11/F12 display · Space blackout · Esc kill · Shift+Esc quit")
