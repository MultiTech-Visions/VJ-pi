...
class ControlWindow:
    ...
    def render(self, frame):
        ...
        # Upload the composed surface and present it. With the HUD's
        # renderer forced to software (see main._open_control_window),
        # from_surface() lands in CPU memory — no GL context to
        # allocate into the wrong one.
